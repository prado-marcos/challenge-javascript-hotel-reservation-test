...
describe("test", function () {
    ...
    it("Should return a error message", function () {
        expect(
            getCheapestHotel(
                "Rewards: 26Mar2009(thur), 27Mar2009(fri), 28Mar2009(sat), 29Mar2009(son)"
            )
        ).to.equal("Cannot read properties of undefined (reading 'name')");
    });
    it("Should return a error message", function () {
        expect(
            getCheapestHotel(
                "Rwrd: 26Mar2009(thur), 27Mar2009(fri), 28Mar2009(sat), 29Mar2009(son)"
            )
        ).to.equal("Cannot read properties of undefined (reading 'name')");
    });
});
